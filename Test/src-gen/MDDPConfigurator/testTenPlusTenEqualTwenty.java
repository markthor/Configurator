...
public class ExpressionHolder {
	...
	public static List<Expression> getExpressions() {
		...
		i = factory.createIntegerValue();
		i.setName("anotherTen");
		i.setType(TypeEnum.get("IntegerType"));
		i.setValue(10);
		expressions.add(i);
		values.put("anotherTen", i);
		constraintMap.put("anotherTen",i);
		i = factory.createIntegerValue();
		i.setName("twenty");
		i.setType(TypeEnum.get("IntegerType"));
		i.setValue(20);
		...
		constraintMap.put("tenPlusTen", bc);
