...
public class ExpressionHolder {
	...
	public static List<Expression> getExpressions() {
		...
		constraintMap.put("trueEqualTrue", bc);
		
		expressions.add(bc);
		bc = factory.createBinaryConstraint();
		bc.setName("falseEqualFalse");
		bc.setOperator(BinaryOperators.EQUAL);
		bc.setRoot(true);
		...
		constraintMap.put("falseEqualFalse", bc);
		
		expressions.add(bc);
		bc = factory.createBinaryConstraint();
		bc.setName("tenEqualTen");
		bc.setOperator(BinaryOperators.EQUAL);
		bc.setRoot(false);
		...
		constraintMap.put("tenEqualTen", bc);
