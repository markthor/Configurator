...
public class CfgDslGenerator implements IGenerator {
  public static CharSequence compileToJava(final Root it) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("class ParameterHolder {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("List<Expression> expressions = getExpressions();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("//HashMap<Expression, Expression> constraintMap = new HashMap<Expression, Expression>();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    {
      ...
      for(final BinaryConstraint expr_6 : _filter_6) {
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("//bc.setLeft(EXPRESSION)");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("//bc.setRight(EXPRESSION)");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("//constraintMap.put(bc, ");
        _builder.append(expr_6, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
    ...
    _builder.newLine();
    {
      ...
      for(final UnaryConstraint expr_7 : _filter_7) {
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("//uc.setExpression(expression)");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("//unsetConstraints.put(uc, ");
        _builder.append(expr_7, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("constraintMap.put(\"");
    ...
    _builder.newLine();
    {
      EList<Expression> _expressions_8 = it.getExpressions();
      Iterable<BinaryConstraint> _filter_8 = Iterables.<BinaryConstraint>filter(_expressions_8, BinaryConstraint.class);
      for(final BinaryConstraint expr_8 : _filter_8) {
        _builder.append("\t\t");
        _builder.append("bc = factory.createBinaryConstraint();");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("bc.setName(\"");
        String _name_14 = expr_8.getName();
        _builder.append(_name_14, "\t\t");
        _builder.append("\");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("bc.setOperator(");
        BinaryOperators _operator_2 = expr_8.getOperator();
        _builder.append(_operator_2, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("bc.setRoot(");
        boolean _isRoot_2 = expr_8.isRoot();
        _builder.append(_isRoot_2, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.newLine();
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("bc.setLeft(RIGHT)");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("unsetConstraints.put(bc, ");
        _builder.append(expr_8, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.newLine();
