 ...
 * <!-- end-user-doc -->
 * @see ConfiguratorPackage.ConfiguratorPackagePackage#getTypeEnum()
 * @model instanceClass="ConfiguratorPackage.TypeEnum"
 * @generated
 */
public enum TypeEnum implements Enumerator {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #INTEGER_TYPE_VALUE
	 * @generated
	 * @ordered
	 */
	INTEGER_TYPE(0, "IntegerType", "IntegerType"),
	 ...
	 * @ordered
	 */
	BOOLEAN_TYPE(1, "BooleanType", "BooleanType"),
	 ...
	 * @ordered
	 */
	STRING_TYPE(2, "StringType", "StringType");
	 ...
	 * @ordered
	 */
	public static final int INTEGER_TYPE_VALUE = 0;
	...
	public static TypeEnum get(int value) {
		switch (value) {
			case INTEGER_TYPE_VALUE: return INTEGER_TYPE;
